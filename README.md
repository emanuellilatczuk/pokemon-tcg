...
O frontend da aplicação vai ser desenvolvido com HTML, CSS e JavaScript e o backend foi simulado pela implementação de uma API Fake (JSON Server) e consumo da API pública Pokémon TCG API.

## 📚 Documentação do Projeto

Para entender as regras de negócio, o escopo e a arquitetura técnica da aplicação, consulte os documentos abaixo:
* [📄 Product Requirements Document (PRD)](docs/prd.md) - Visão geral, atores e histórias de usuário.
* [🛠️ Especificação Técnica (Tech Spec)](docs/spec.md) - Diagrama de banco de dados (DER), dicionário de dados e rotas da API (JSON Server/PokeAPI).
...
- [ ] **ID 12** - Aplica expressões regulares (REGEX) para validações customizadas (e-mail, telefone, após, etc.)
